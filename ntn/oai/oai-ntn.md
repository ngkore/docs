...
> _Part 2 of 2: OpenAirInterface (OAI) NTN Series_
...
_RCconfig_nr_macrlc(cfg) — MAC & RLC Layer Configuration Entry Point:_  
...
_nr_mac_config_scc() — Applying NTN Offsets in MAC:_  
...
_prepare_scc() — Finalizing Serving Cell Config (RRC Layer):_  
...
_get_SIB1_NR() — Populating NTN-Specific Fields in SIB1:_  
...
_Control Returns to RCconfig_nr_macrlc(cfg):_  
...
_gNB_dlsch_ulsch_scheduler() — Main Downlink+Uplink Scheduling Function (every slot):_  
...
_Uplink Preprocessor — nr_ulsch_preprocessor():_  
...
_Msg3 Received and Msg4 Scheduling Begins:_  
...
_Continuous Loop After Msg3 — Main Slot Scheduler:_  
...
_apply_ntn_config() Called from UE_thread() (Repeatedly):_  
...
_SIB19 Decoding and NTN Configuration Transfer:_  
...
_nr_rrc_mac_config_other_sib() — Applying SIB19 and Starting RA (NTN-Specific):_  
...
_configure_ntn_ta() — Computing Total UE Timing Advance for NTN:_  
...
_schedule_ntn_config_command() — Delivering NTN Timing to PHY Layer:_  
...
_nr_ue_scheduled_response_dl() and configure_ntn_params() — Final PHY Configuration:_  
...
_UE Initiates 4-Step Random Access Procedure with NTN Adjustments:_  
...
_Msg1 Sent, Msg2 Received, TA Applied (NTN Flow):_  
...
_Msg3 Transmission — NTN Timing Fully Applied:_  
...
_Msg4 Acknowledged — RA Procedure Successful:_  
...
_Post-RA: UE Begins RRC Setup Completion:_  
...
![Alternative text](./images/UE_GEO.png)
